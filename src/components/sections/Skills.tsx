                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <Label htmlFor={`title-${skill.id}`} className="text-sm font-medium">技能名称</Label>
                    </div>
                    <Input
                      id={`title-${skill.id}`}
                      value={skill.title}
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <Label htmlFor={`details-${skill.id}`} className="text-sm font-medium">详细描述</Label>
                    </div>
                    <Textarea
                      id={`details-${skill.id}`}
                      value={skill.details}
                      onChange={(e) => handleUpdateSkill(skill.id, 'details', e.target.value)}
                      placeholder="10年以上 HTML5, CSS3, JavaScript (ES6+), TypeScript, React, Next.js 经验"
